...
use frontend\models\CveDetails;

/**
 * CveDetailsSearch represents the model behind the search form about `app\models\CveDetails`.
 */
class CveDetailsSearch extends CveDetails
{
    /**
     * @inheritdoc
     */
