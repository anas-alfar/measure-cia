...
class WizardMenu extends Menu
{
     ...
     */
    public $currentStepCssClass = 'btn btn-default btn-primary'; // 'current-step';
    /**
     ...
     */
    public $futureStepCssClass = 'btn btn-default disabled '; // 'future-step';
    /**
     * @var string The CSS class for past steps
     */
    public $pastStepCssClass = 'btn btn-default btn-success '; // 'past-step';
    /**
